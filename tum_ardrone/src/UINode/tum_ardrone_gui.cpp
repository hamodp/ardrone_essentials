...
//AED added to make keyboard control tuneable
    ...
    : QWidget(parent)
{
	ui.setupUi(this);
	rosThread = NULL;
//AED these vars change manual control speeds
...
/*********************************************************
function added to toggle between no control and kb control
for use with ros service made in the main function of the
UI
*/
void tum_ardrone_gui::setControlSourceKB()
{
